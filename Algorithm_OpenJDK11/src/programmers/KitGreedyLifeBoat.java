...
public class KitGreedyLifeBoat {
    ...
    private static int solution(int[] people, int limit) {
        ...
        while(peopleList.size() !=0) {
            int origin = peopleList.pollLast();   // 최대값
            int sum =0;
    ...
    private static boolean isOverLimit(int sum, int target, int limit) {
        return sum+target > limit ? true : false;
    }
